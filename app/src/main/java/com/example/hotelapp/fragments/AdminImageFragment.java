...
public class AdminImageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((AdminActivity)getActivity()).setActionBarTitle("Images");
        View view = inflater.inflate(R.layout.fragment_admin_image_item_list, container, false);
        RecyclerView recyclerView=view.findViewById(R.id.admin_image_list);
        ...
        if (recyclerView instanceof RecyclerView) {
            ...
            AdminImageRecyclerViewAdapter adapter=new AdminImageRecyclerViewAdapter(getContext());
            db.imageDao().getImages().observe(getViewLifecycleOwner(),data->adapter.setData(data));
            recyclerView.setAdapter(adapter);
        }

        FloatingActionButton addButton=view.findViewById(R.id.admin_image_item_list_fab);
