...
public class AdminPriceFragment extends Fragment {
    ...
    public static AdminPriceFragment newInstance(int columnCount) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (recyclerView instanceof RecyclerView) {
            ...
            AdminPriceRecyclerViewAdapter adapter=new AdminPriceRecyclerViewAdapter(getContext());
            db.priceDao().getPrices().observe(getViewLifecycleOwner(),data->adapter.setData(data));
            recyclerView.setAdapter(adapter);
        }

        FloatingActionButton addButton=view.findViewById(R.id.admin_price_item_list_fab);
        addButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i=new Intent(getContext(), EditPriceActivity.class);
